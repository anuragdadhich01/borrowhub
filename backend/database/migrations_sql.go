...
// PostgreSQL specific migration implementations
func (d *PostgreSQLDatabase) getPostgresSchemaMigration() string {
	return `
-- Create users table
...
func (d *PostgreSQLDatabase) getPostgresAdditionalTablesMigration() string {
	return `
